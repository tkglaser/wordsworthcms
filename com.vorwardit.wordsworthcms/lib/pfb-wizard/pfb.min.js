            ...
            OrderController.prototype.submit = function () {
                ...
                if (this.form.$valid) {
                    ...
                    this.requestService.update(newData).then(function () {
                        _this.locationService.path('/orderconfirm/' + _this.requestId + '/' + _this.offerId + '/' + _this.form["paymode"].$modelValue);
                    }, function () {
                        // TODO
                    });
                }
